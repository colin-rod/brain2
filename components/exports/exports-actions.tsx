...
export function ExportsActions({ noteId }: { noteId: string }) {
  ...
  return (
    <div className="flex items-center gap-north-xs shrink-0">
      ...
      <Button variant="ghost" size="sm" onClick={handleRegenerate} disabled={isExporting}>
        {isExporting ? (
          <Loader2 className="h-3.5 w-3.5 animate-spin" />
        ) : (
